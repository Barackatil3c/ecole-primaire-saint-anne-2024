...
include '../conn.php';
 ...
 if(isset($_POST['submit'])){
    ...
    $insert=$conn->query("UPDATE products SET ProductName='$pname',PricePerKg='$price',quantity='$quantity',Total_price='$total' WHERE ProductId=$pid");
    if($insert){
          ...
          <?php
                  ...
                  $select_prod=$conn->query("SELECT * FROM products WHERE ProductId='$pid'");
                    ...
                    <div class="placeholder">
                        ...
                        <input type="text" value="<?=$row['PricePerKg']?>" name="PricePerKg" class="form-control">
                    </div><br>
                    <div class="placeholder">
                        <span class="input-group-text"><i class="fa-solid fa-money-bill"></i>&nbsp; Quantity</span>
                        <input type="text" value="<?=$row['quantity']?>"placeholder="Enter product quantity" name="quantity" class="form-control">
                    </div>
                    <center><button type="submit" name="submit" class="btn btn-warning"><i class="fa-solid fa-plus"></i>Update</button></center>
                    <?php
                    }
                    ?>
                </form>
