        ...
        <div class="row justify-content-center">
            <div class="col-sm-4 mt-5 p-3 border rounded shadow">
                <form  method="post" >
                    ...
                    <center><Button type="submit" class="btn btn-warning text-white" name="submit"style="background-color:#07ffb7; border-color:#07ffb7;">Sign up</Button></center>
                    <center><span>Already have account <a href="login.php" class="alert-link">login</a></span></center>
                </form>
            </div>
        </div>
    </div>
